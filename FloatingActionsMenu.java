...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private Drawable getAddIconDrawable() {
    final FloatingActionsMenu.RotatingDrawable rotatingDrawable = new FloatingActionsMenu.RotatingDrawable(mAddButton.generateIconDrawable());
  ...
  public void initAddButton(final int plusColor, final int normalColor, final int pressedColor, final int size, final boolean showShadow) {

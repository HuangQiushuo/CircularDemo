...
/**
 * Created by Qiushuo Huang on 2017/5/12.
 */

public class FloatingMenuAddButton extends FloatingActionButton {
    int mPlusColor;

    public FloatingMenuAddButton(Context context) {
        this(context, null);
    }

    public FloatingMenuAddButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FloatingMenuAddButton(Context context, AttributeSet attrs, int defStyle) {

...
public class ITimeFloatingMenu extends ViewGroup {
    ...
    public ITimeFloatingMenu(Context context) {
        this(context, null);
    }

    public ITimeFloatingMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ITimeFloatingMenu(Context context, AttributeSet attrs, int defStyle) {
...
//        mAddButton.setIconDrawable(getAddIconDrawable());
//
...
//    }
    ...
    private Drawable getAddIconDrawable(Drawable addDrawable) {
        final ITimeFloatingMenu.RotatingDrawable rotatingDrawable = new ITimeFloatingMenu.RotatingDrawable(addDrawable);
    ...
    public void initAddButton(Drawable addDrawable, final int plusColor, final int normalColor, final int pressedColor, final int size, final boolean showShadow) {
        removeView(mAddButton);
        mAddButtonColorNormal = normalColor;
        mAddButtonColorPressed = pressedColor;
        mAddButtonSize = size;
        mAddButtonPlusColor = plusColor;
        mAddButton = new View(getContext());
        mAddButton.setBackground(getAddIconDrawable(addDrawable));
//
//        mAddButton = new AddFloatingActionButton(getContext());
//        mAddButton.setShowShadow(showShadow);
//        mAddButton.setPlusColor(plusColor);
//        mAddButton.setColorNormal(normalColor);
//        mAddButton.setColorPressed(pressedColor);
//        mAddButton.setSize(size);
//        mAddButton.setIconDrawable(getAddIconDrawable());
